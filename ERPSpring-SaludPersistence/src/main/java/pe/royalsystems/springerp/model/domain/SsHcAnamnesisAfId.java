...
/**
 * SsHcAnamnesisAfId generated by hbm2java
 */
@Embeddable
public class SsHcAnamnesisAfId implements java.io.Serializable {
	...
	public SsHcAnamnesisAfId() {
	}

	public SsHcAnamnesisAfId(String unidadReplicacion, long idEpisodioAtencion, int idPaciente, int episodioClinico) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SsHcAnamnesisAfId))
			return false;
		SsHcAnamnesisAfId castOther = (SsHcAnamnesisAfId) other;
