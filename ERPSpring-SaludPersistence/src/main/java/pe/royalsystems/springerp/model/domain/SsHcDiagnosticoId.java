...
// default package
// Generated Sep 25, 2015 12:04:31 PM by Hibernate Tools 4.3.1

import javax.persistence.Column;
import javax.persistence.Embeddable;

/**
 * SsHcDiagnosticoId generated by hbm2java
 */
@Embeddable
public class SsHcDiagnosticoId implements java.io.Serializable {
	...
	public SsHcDiagnosticoId() {
	}

	public SsHcDiagnosticoId(int secuencia, long idEpisodioAtencion, int idPaciente, int episodioClinico,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SsHcDiagnosticoId))
			return false;
		SsHcDiagnosticoId castOther = (SsHcDiagnosticoId) other;
		...
		return (this.getSecuencia() == castOther.getSecuencia())
				...
				&& ((this.getUnidadReplicacion() == castOther.getUnidadReplicacion())
