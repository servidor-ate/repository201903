package pe.royalsystems.springerp.service.util;
...
public abstract class Constant implements Serializable{
	...
	public static String PERFIL_DOCENTE = "DOCENTE";
...
//	public static final int MODALIDAD_ESTUDIO_MONITOREO = 3;
	...
	public static final String TURNO_TURDESCRIPCION_MANANA = "MA@ANA";
...
//	public static final int ESTADO_ALUMNO_DADO_BAJA = 4;//CONSTANTE PARA ELIMINAR
	...
	/** CONSTANTES PARA LOS ESTADOS DE PEDIDO DE OBLIGACIONES DEL ALUMNO - INTEGRACION ERP COMERCIAL **/
	public static final int PEDIDO_OBLIGACION_ESTADO_PENDIENTE = 1;
	public static final int PEDIDO_OBLIGACION_ESTADO_COBRADO = 2;
	public static final int PEDIDO_OBLIGACION_ESTADO_ANULADO = 3;
